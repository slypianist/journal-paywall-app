...
/* Non Autheticated Routes........................ */
    ...
    Route::post('contact', [PagesController::class, 'sendContactInfo'])->name('send.contact');
    Route::get('reader/password', [PagesController::class, 'showEmailForm'])->name('send.reset');
    Route::post('reader/password/reset', [PasswordController::class, 'sendReaderPasswordResetLink'])->name('send.resetlink');
    Route::get('reader/reset-password/{token}/{email}', [PasswordController::class, 'showResetForm'])->name('reader.password.reset');
    Route::post('/reader/reset-password', [PasswordController::class, 'resetPassword'])->name('reader.password.update');
