        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Subcriptions</span>
            </a>
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li>
                <a href="settings.html"> Manage subcriptions </a>
              </li>
              <li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_3" class="collapse dropdown-nav">
              <li>
                <a href="signin.html"> Edit Profile </a>
              </li>
            ...
            <div class="col-md-6 order-last order-md-first">
              <div class="copyright text-center text-md-start">
                <p class="text-sm">
                  ...
                  <a href="https://deepoceanconsults.com" rel="nofollow" target="_blank">
                    DeepOcean Consults Ltd
                  </a>
                </p>
              </div>
            </div>
