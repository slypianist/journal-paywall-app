        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    @endif
                        <form action="{{route('episodes.store', $podcast->id)}}" method="POST" class="mb-5" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="description" id="body" value="{{old('description')}}"></textarea>
                                @error('description')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                <button type="submit" class="btn btn-dark">Add Episode</button>
                            </div>
                        </form>
